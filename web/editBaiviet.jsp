<%-- 
    Document   : edit
    Created on : Nov 14, 2022, 8:42:55 PM
    Author     : HPs
--%>
				...
				<div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
						...
						<div class="row">
							...
							<div class="col-12 mb-3">
                                                            ...
                                                            <input value="${news.name}" name="name" type="text" class="form-control" placeholder="TÊN BÀI VIẾT">
</div>
                                                        
                                                    
							<div class="col-6 mb-3">
                                                             <select name="cater" class="form-control" value="${news.id}">
							...
							<div class="col-12 mb-3">
								...
								<textarea name="detail" class="form-control" rows="8">${news.detail}</textarea>
                                                        ...
                                                        <div class="col-6 mb-3">
                                                            ...
                                                            <input value="${news.image}"  type="file" class="form-control" name="image" />
                                                         </div>
